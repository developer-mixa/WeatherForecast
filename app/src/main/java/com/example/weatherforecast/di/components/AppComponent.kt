...
import com.example.weatherforecast.di.modules.WeatherRepositoryModule
...
@Singleton
@Component(modules = [
    CitiesRepositoryModule::class, RetrofitModule::class, ViewModelsModule::class, WeatherRepositoryModule::class
])
